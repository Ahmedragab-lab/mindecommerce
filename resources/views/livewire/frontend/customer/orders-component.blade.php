                        ...
                        @foreach($order->products as $product)
                            <tr>
                                <td>
                                    ...
                                    <img src="{{ asset('images/products/'.$product->firstMedia->file_name) }}" alt="{{ $product->name }}" class="img-fluid " style="width:85px;">
                                    @else
                                    <img src="{{ asset('images/no-image.jpg') }}" alt="{{ $product->name }}" class="img-fluid " style="width:85px;">
                                    @endif
                                </td>
                                <td>{{ $product->name }}</td>
