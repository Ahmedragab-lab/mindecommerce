                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">cities
                                    <span style="color: red;font-weight:bolder;"> {{\App\Models\City::count() }} </span>
                                </h4>
                            ...
                            <div class="card-content collapse show">
                                <a href="{{ route('admin.cities.index') }}" class="btn btn-info mb-3 " style="margin-left: 50px;float: left;">
                                    <i class="icon-action-undo"></i> Back to cities
                                </a>
                                ...
                                <div class="card-body card-dashboard">
                                    @include('dashboard.cities.filter')
                                                    ...
                                                    <tr>
                                                       <th >
                                                        <div class="animated-checkbox">
                                                            <label class="m-0">
                                                                <input type="checkbox" value="{{ $city->id }}" name="delete_select" id="delete_select">
                                                        ...
                                                        <td>{{ $city->status()}}</td>
                                                        <td>
                                                            @include('dashboard.cities.action')
                                                        </td>
                                                    </tr>
                                                @empty
                                                    <tr>
