        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">edit user <span style="color: red;">{{ $user->full_name }}</span></h3>
                                        ...
                                        <form class="form" action="{{ route('admin.users.update',$user->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        @if($user->image)
                                                          <img src="{{ asset('images/users/'.$user->image) }}" alt="{{ $user->full_name }}" class="img-thumbnail img-preview" width="200px">
                                                        @else
