        ...
        <div class="col-2">
            <div class="form-group">
                <select name="sort_by" class="form-control">
                    ...
                    <option value="firstname" {{ old('sort_by', request()->input('sort_by')) == 'firstname' ? 'selected' : '' }}>First Name</option>
                    <option value="lastname" {{ old('sort_by', request()->input('sort_by')) == 'lastname' ? 'selected' : '' }}>Last Name</option>
        ...
        <div class="col-1">
            <div class="form-group">
                <button type="submit" name="submit" class="btn btn-primary width-100" title="search">
                    <i class="icon-eye"></i> ابحث</button>
            </div>
        </div>
    </div>
    </form>
