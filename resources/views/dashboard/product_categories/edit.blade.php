        ...
        <div class="content-wrapper">
            <div class="content-header row">
                <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                    <h3 class="content-header-title mb-0 d-inline-block">قسم : <strong style="color: red;">{{ $productCategory->name }}</strong></h3>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{ route('admin.product_categories.update',$productCategory->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="form-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="parent_id" class="form-control">
                                                                ...
                                                                @forelse($cats as $cat)
                                                                    <option value="{{ $cat->id }}"
                                                                        {{ old('parent_id',$productCategory->parent_id)==$cat->id?'selected':null }} >
                                                                        {{ $cat->name }}
                                                                    </option>
                                                                @empty
                                                                @endforelse
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        @if($productCategory->cover)
                                                          <img src="{{ asset('images/product_categories/'.$productCategory->cover) }}"
                                                          alt="{{ $productCategory->name }}" class="img-thumbnail img-preview" width="200px">
                                                        @else
