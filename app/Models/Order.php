...
class Order extends Model
{
    ...
    const RETURNED = 7;
    const REFUNDED = 8;
    const PAYMENT_FAILED = 9;

    public function currency(): string
    {
        return $this->currency == 'LE' ? 'LE' : $this->currency;
    }
    ...
    public function statusWithLabel()
    {
        switch ($this->order_status) {
            case 0: $result = '<label class="btn btn-success">New order</label>'; break;
            case 1: $result = '<label class="btn btn-warning">Paid</label>'; break;
            case 2: $result = '<label class="btn btn-warning">Under process</label>'; break;
            case 3: $result = '<label class="btn btn-primary">Finished</label>'; break;
            case 4: $result = '<label class="btn btn-danger">Rejected</label>'; break;
            case 5: $result = '<label class="btn btn-dark text-white">Canceled</label>'; break;
