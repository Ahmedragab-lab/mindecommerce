<div class="bn-group">
    <a class="btn btn-success btn-sm fonticon-wrap width-50" href="{{ route('admin.tags.edit',$tag->id )}}" title="edit">
        <i class="icon-note"></i>
    </a>
    <button type="button" class="btn btn-danger btn-sm width-50" data-toggle="modal" data-target="#delete{{ $tag->id }}" title="delete">
        <i class="icon-trash"></i>
    </button>
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-group">
            <!-- Modal -->
            <div class="modal animated rubberBand text-left"  tabindex="-1" role="dialog" aria-hidden="true" id="delete{{ $tag->id }}">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="{{ route('admin.tags.destroy',$tag->id )}}" class="my-1 my-xl-0" method="post" style="display: inline-block;" >
                                @csrf
                                @method('delete')
...
{{-- modal bulk delete --}}
<form action="{{ route('admin.tags.bulk_delete','ids') }}" class="my-1 my-xl-0" method="post" style="display: inline-block;" autocomplete="off">
    @csrf
    @method('delete')
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-group">
