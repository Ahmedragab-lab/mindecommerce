<div class="bn-group">
    <a class="btn btn-success btn-sm fonticon-wrap width-50" href="{{ route('admin.coupons.edit',$coupon->id )}}" title="edit">
        <i class="icon-note"></i>
    </a>
    <button type="button" class="btn btn-danger btn-sm width-50" data-toggle="modal" data-target="#delete{{ $coupon->id }}" title="delete">
        <i class="icon-trash"></i>
    </button>
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-group">
            <!-- Modal -->
            <div class="modal animated rubberBand text-left"  tabindex="-1" role="dialog" aria-hidden="true" id="delete{{ $coupon->id }}">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form action="{{ route('admin.coupons.destroy',$coupon->id )}}" class="my-1 my-xl-0" method="post" style="display: inline-block;" >
                                @csrf
                                @method('delete')
...
{{-- modal bulk delete --}}
<form action="{{ route('admin.coupons.bulk_delete','ids') }}" class="my-1 my-xl-0" method="post" style="display: inline-block;" autocomplete="off">
    @csrf
    @method('delete')
    <div class="col-lg-4 col-md-6 col-sm-12">
        <div class="form-group">
